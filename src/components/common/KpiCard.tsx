...
const THEME_CLASSES = {
  blue: {
    ...
    activeBg: 'bg-blue-500/10 border-blue-500 ring-2 ring-blue-500/50 shadow-blue-500/20',
  },
  indigo: {
    ...
    activeBg: 'bg-indigo-500/10 border-indigo-500 ring-2 ring-indigo-500/50 shadow-indigo-500/20',
  },
  emerald: {
    ...
    activeBg: 'bg-emerald-500/10 border-emerald-500 ring-2 ring-emerald-500/50 shadow-emerald-500/20',
  },
  amber: {
    ...
    activeBg: 'bg-amber-500/10 border-amber-500 ring-2 ring-amber-500/50 shadow-amber-500/20',
  },
  rose: {
    ...
    activeBg: 'bg-rose-500/10 border-rose-500 ring-2 ring-rose-500/50 shadow-rose-500/20',
  },
  purple: {
    ...
    activeBg: 'bg-purple-500/10 border-purple-500 ring-2 ring-purple-500/50 shadow-purple-500/20',
  },
  slate: {
    ...
    activeBg: 'bg-slate-500/10 border-slate-500 ring-2 ring-slate-500/50 shadow-slate-500/10',
  },
};
